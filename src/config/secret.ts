...
export const GITHUB_REDIRECT_URI = '**********'; // github登录回调地址

export const GAODE_WEB_IP_URL = '**********'; // 高德地图url
export const GAODE_WEB_IP_KEY = '**********'; // 高德地图key

export const QQ_EMAIL_USER = '824723712@qq.com'; // qq邮箱auth的用户
export const QQ_EMAIL_PASS = 'dczyvtyllvsmbcda'; // qq邮箱auth的秘钥
...
export const MAIL_OPTIONS_CONFIG = {
  from: '824723712@qq.com', // sender address
